-- Enable PostGIS (required before any geography column can be created)
...
-- CreateIndex: GIST spatial index on ProviderProfile.location (PostGIS requirement — cannot use btree)
CREATE INDEX "ProviderProfile_location_gist_idx" ON "ProviderProfile" USING GIST ("location");
